...
4. Now we have to update the `mfe-core` app to show our local version of Forums App, instead of remote one. Update file `mfe-core/config/micro-frontends-config-local.json`:
